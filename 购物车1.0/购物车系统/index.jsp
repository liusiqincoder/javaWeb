...
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" href="登陆界面前端/css/normalize.css">
    <link rel="stylesheet" href="登陆界面前端/css/login.css">
    <link rel="stylesheet" href="登陆界面前端/css/sign-up-login.css">
    <link rel="stylesheet" type="text/css" href="登陆界面前端/css/font-awesome.min.css">
    <link rel="stylesheet" href="登陆界面前端/css/inputEffect.css"/>
    <link rel="stylesheet" href="登陆界面前端/css/tooltips.css"/>
    <link rel="stylesheet" href="登陆界面前端/css/spop.min.css"/>

    <script src="登陆界面前端/js/jquery.min.js"></script>
    <script src="登陆界面前端/js/snow.js"></script>
    <script src="登陆界面前端/js/jquery.pure.tooltips.js"></script>
    <script src="登陆界面前端/js/spop.min.js"></script>
    <script>
        (function () {
        ...
        function login() {//登录
            ...
            if (flag) {
                ...
                //调用后台登录验证的方法
                window.location.href = "/exisitsUser?name=" + username + "&password=" + password;
//			alert('登录成功');
                return true;
            }
        }
        ...
        function register() {
            ...
            if (flag) {
                ...
                window.location.href = "/register?name=" + username + "&password=" + password;
                spop({
    ...
    <style type="text/css">
        ...
        body {
            ...
            background-image: url(登陆界面前端/images/snow.jpg);
